...
+ (UIImage*) thumbnailImageForVideo:(NSURL *)videoURL atTime:(NSTimeInterval)time
{
        ...
        thumbnailImageRef = [assetImageGenerator copyCGImageAtTime:CMTimeMake(asset.duration.value, asset.duration.timescale) actualTime:NULL error:&thumbnailImageGenerationError];
